...
- `data/raw/properties.csv`: original Sri Lankan property dataset, approximately 203,874 rows. Never modify directly and never commit to GitHub.
- `data/processed/properties_cleaned.csv`: main cleaned dataset, approximately 202,309 rows. This is the future Agent 2 retrieval source and must stay out of Git.
...
- `data/local/properties_dev.csv`: development sample of about 10,000 rows for early Supabase development, Agent 2 development, embedding experiments, and hybrid search testing. Do not commit this file.
